<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form ref="check" :model="check" label-width="150px"  style='margin-left:50px;'>
        <el-form-item label="选择时间VVVVVVVVV">
          <el-date-picker
      ...
      <el-form ref="check" :model="check" label-width="150px"  style='margin-left:50px;'>
        <el-form-item>
          <el-button type="primary" icon="plus" size="mini" @click="checkTime()">检查
          </el-button>
          <el-button type="primary" icon="plus" size="mini" @click="addTime()">确认
          </el-button>
        </el-form-item>
      </el-form>
    ...
    methods: {
      checkTime(){
        this.api({
          ...
          if(data.inTime){
          this.$message.success('在配送时间之内');
          }else{
          this.$message.warning('不在配送时间之内');
        }
        })
      },
      getList() {
